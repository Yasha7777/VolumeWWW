...
function Swan() {
  ...
  // (см. .kh-swan { color }). Живёт только в пустом состоянии.
  return (
    <svg
      viewBox="0 0 140 120"
      className="kh-swan"
    ...
    >
      {/* спина и хвост */}
      <path d="M22 76 C 20 56, 46 50, 66 58" />
      {/* грудь и живот на воде */}
      <path d="M22 76 C 30 92, 82 94, 102 76" />
      {/* крыло — внутренняя линия */}
      <path d="M38 74 C 52 62, 74 64, 88 74" />
      {/* шея (S) */}
      <path d="M66 58 C 80 62, 82 34, 92 26" />
      {/* голова */}
      <circle cx="97" cy="22" r="6" />
      {/* клюв */}
      <path d="M103 20 L 113 24 L 103 27" />
      {/* линия воды */}
      <path d="M40 102 L 96 102" opacity="0.45" />
    </svg>
  );
}
