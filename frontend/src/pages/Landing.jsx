...
/*
  ...
  THESIS: ТЁМНЫЙ мир-«прибор», отдельный от кремового приложения.
    ХИРО — fullscreen-видео сборки насыпи под тонким скримом; ниже — тёмное
  ...
  OWN-WORLD: уголь #0E140A, лес (заливка кнопок) #3A6E26, золото #e7b552,
    крем (текст) #F1EDE1. Cormorant + Onest.
  NB: приложение (/app) живёт в ДРУГОМ мире — кремовом/тёмном по теме
    пользователя. Не тащи сюда токены из styles.css и обратно.
  ─────────────────────────────────────────────────────────────────────────
*/
